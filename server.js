...
        // --- ДОДАНО ---
        // Відправляємо новому гравцю, скільки вже є спостерігачів
...
        // --- ДОДАНО: Оновлення сітки на сервері ---
        const opponentGridKey = opponent.color; // 'blue' or 'red'
...
            }
            room.grids[opponentGridKey][y][x] = 2; // 2 = влучання
        } else {
            room.grids[opponentGridKey][y][x] = 1; // 1 = промах
        }
...
            // --- ЗМІНЕНО: відправляємо 'gameOver' ВСІМ у кімнаті ---
...
            room.spectators = {}; // --- ДОДАНО: Очищуємо спостерігачів
            io.emit('roomList', getRoomStatus());
            return;
        }
...
        // --- ДОДАНО: Логіка виходу спостерігача ---
...
            // Спостерігач просто виходить, нічого не ламається
        } 
        // --- ОНОВЛЕНО: Логіка виходу гравця ---
...
    // --- ДОДАНО: Скидання сіток на сервері ---
    room.grids = {
